...
public static class Config
{
    ...
    public static Vector3 RealToUnityPositionScale(float y, float x){
        Vector3 position = Vector3.zero; 
        switch(ORIGIN){
            case MapOriginPosition.TopLeft:
                position.x = (REAL_MAP_DIMENSION_Y-x)/GetRatioUnityToRealInX();
    ...
    public static Vector2 UnityToRealPositionScale(float y, float x){
